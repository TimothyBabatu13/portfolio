...
<template>
  <nav class="flex items-center justify-between px-4 py-4 lg:px-16 lg:py-6">
    ...
    <div class="hidden lg:flex items-center gap-4">
      <RouterLink
        to="https://www.linkedin.com/in/timothy-akanbi?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
        target="_blank"
      ...
      <RouterLink
        to="https://github.com/timothybabatu13"
        target="_blank"
        class="bg-[#222] w-14 h-14 rounded-full flex justify-center items-center"
      >
        <GithubIcon />
      ...
      <RouterLink
        to="https://x.com/timothy_akanbii"
        target="_blank"
        class="bg-[#222] w-14 h-14 rounded-full flex justify-center items-center"
      >
        <TwitterIcon />
